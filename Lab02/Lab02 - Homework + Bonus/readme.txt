...
UPDATE: Pentru masurare timp folosesc System.nanoTime() salvat de 2 ori, o data la inceput de main, o data la final si apoi scad din cel final pe cel initial si aflu care este durata de timp pentru rularea codului. Pentru a masura memoria creez un obiect de tip Runtime si folosind acest obiect accesez comenzi specific acestei clase precum totalMemory si freeMemory, apelez acestea 2 la inceput o data pentru a calcula memoria folosita de main la start, apoi din nou la final si calculez printr-o scadere memoria folosita de acest cod.